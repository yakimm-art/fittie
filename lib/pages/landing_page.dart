            ...
            children: [
              FadeSlideIn(
                child: Container(
                  ...
                  child: Text("POWERED BY GEMINI 3",
                      style: GoogleFonts.inter(
                          fontSize: 12,
                          fontWeight: FontWeight.w900,
                          color: Colors.white,
              ...
              FadeSlideIn(
                  delayMs: 100,
                  child: Text("Gemini 3 Intelligence.",
              ...
              FadeSlideIn(
                  ...
                  child: ConstrainedBox(
                    ...
                    child: Text(
                      "Every workout is generated by Gemini 3 Flash — using your history, energy, and equipment to build the perfect session.",
                      textAlign: TextAlign.center,
                      style: GoogleFonts.inter(
                          fontSize: 17,
                          color: AppColors.textSoft,
                    ...
                    FadeSlideIn(
                        child: const SizedBox(
                            ...
                            child: PopBentoCard(
                              ...
                              icon: "✨",
                              desc:
                                  "Gemini 3 generates unique workouts from your profile and 50-session history.",
                    ...
                    FadeSlideIn(
                        ...
                        child: const SizedBox(
                            ...
                            child: PopBentoCard(
                              ...
                              icon: "📷",
                              desc:
                                  "Upload a photo of your gym — Gemini Vision detects equipment and builds a routine.",
                    ...
                    FadeSlideIn(
                        ...
                        child: const SizedBox(
                            ...
                            child: PopBentoCard(
                              title: "Smart Chat",
                              icon: "💬",
                              desc: "AI coach that remembers every conversation and your workout history.",
                              color: AppColors.accentYellow,
                            ))),
                  ],
                )
                      ...
                      children: [
                        Expanded(
                          ...
                          child: const PopBentoCard(
                            ...
                            icon: "✨",
                            desc:
                                "Gemini 3 Flash generates unique workouts from your profile, energy level, and 50-session history. No two sessions repeat.",
                            color: AppColors.primaryLight,
                          ),
                        ),
                        const SizedBox(width: 24),
                            ...
                            children: const [
                              Expanded(
                                child: PopBentoCard(
                                  ...
                                  icon: "📷",
                                  desc:
                                      "Gemini Vision identifies your equipment from a photo.",
                                  color: AppColors.accentPink,
                                ),
                              ),
                              SizedBox(height: 24),
                              Expanded(
                                child: PopBentoCard(
                                  title: "Chat Memory",
                                  icon: "🧠",
                                  desc: "Persistent AI coach that remembers every conversation.",
                        ...
                        Expanded(
                          ...
                          child: const PopBentoCard(
                            ...
                            icon: "📊",
                            desc:
                                "Tracks progression across 50+ sessions with plateau detection and muscle balance.",
                            color: AppColors.accentYellow,
                          ),
                        ),
                      ],
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      _FooterColumn(
                          title: "Product",
                          links: const ["Features", "Blog", "Community"],
                          routes: {
